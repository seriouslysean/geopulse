...
export const getTwitterUserUrl = screen_name => `https://www.twitter.com/${screen_name}`;
      ...
      case 'hashtags':
        _.each(entities[key], (e) => {
          toReplace.push({
            ...
            replace: `<a href="https://www.twitter.com/hashtag/${
              e.text
            }?src=hash" target="_blank">#${e.text}</a>`,
          });
        });
        break;
      case 'media':
      ...
      case 'user_mentions':
        _.each(entities[key], (e) => {
          toReplace.push({
            ...
            replace: `<a href="https://www.twitter.com/${e.screen_name}" target="_blank">@${
              e.screen_name
            }</a>`,
          });
        });
